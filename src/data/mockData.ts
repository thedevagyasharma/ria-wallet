...
export const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  // USD → MXN — completed
  {
    ...
    amount: -202.00,
    currency: 'USD',
    date: new Date('2026-04-15T10:15:00'),
    status: 'completed',
    ref: 'RIA-K7M2PL',
    fee: 2.00,
    receivedAmount: 3430.00,
    receiveCurrency: 'MXN',
    rate: 17.15,
    eta: 'Within minutes',
  },
  ...
  // MXN — incoming
  {
    ...
    amount: 1500.00,
    currency: 'MXN',
    date: new Date('2026-04-10T14:20:00'),
    status: 'completed',
    ref: 'RIA-C8P3NV',
  },
  ...
  // PHP → PHP — failed
  {
    ...
    rate: 1,
    eta: 'Instant',
    note: 'Transfer rejected by payment network',
  },
  // PHP — incoming
  {
    id: 'tx-p2p-8',
